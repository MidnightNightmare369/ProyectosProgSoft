...
namespace asp_servicios.Controllers
{
    ...
    {
        private IParqueaderosApp? iAplicacion = null;
        private TokenController? tokenController = null;

        public ParqueaderosController(IParqueaderosApp? iAplicacion,
        ...
        public string PorNombre()
        {
            ...
            try
            {
                ...
                var entidad = JsonConversor.ConvertirAObjeto<Parqueaderos>(
