...
namespace asp_presentacion.Pages.Ventanas
{
    ...
    {
        private ITarifasPresentacion? iPresentacion = null;

        public TarifasModel(ITarifasPresentacion iPresentacion)
        {
            try
            {
        ...
        [BindProperty] public Tarifas? Actual { get; set; }
        [BindProperty] public Tarifas? Filtro { get; set; }
