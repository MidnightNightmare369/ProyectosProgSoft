...
namespace asp_presentacion.Pages.Ventanas
{
    ...
    {
        private IAuditoriasPresentacion? iPresentacion = null;  //Clase principal
        //Clases asociada 


        //Las clases asociadas tambien se mandan como parametros en el contructor
        ...
        public void OnPostBtRefrescar()
        {
            try
            {
                ...
                Filtro!.TipoModificacion = Filtro!.TipoModificacion ?? "";

                Accion = Enumerables.Ventanas.Listas;

                var task = this.iPresentacion!.PorTipoModificacion(Filtro!);
                task.Wait();
                Lista = task.Result;
                Actual = null;
            }
