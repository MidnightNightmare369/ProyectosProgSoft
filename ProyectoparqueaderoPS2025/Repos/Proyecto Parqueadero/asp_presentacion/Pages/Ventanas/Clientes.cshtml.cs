...
namespace asp_presentacion.Pages.Ventanas
{
    public class ClientesModel : PageModel
    {
        ...
        private ITipoClientesPresentacion? iTipoClientesPresentacion = null;
        private IVehiculosPresentacion? iVehiculosPresentacion = null;

        public ClientesModel(IClientesPresentacion iPresentacion,
            ITipoClientesPresentacion iTipoClientesPresentacion,
            IVehiculosPresentacion? iVehiculosPresentacion)
        {
            try
            {
                this.iPresentacion = iPresentacion;
                this.iTipoClientesPresentacion = iTipoClientesPresentacion;
        ...
        [BindProperty] public List<TipoClientes>? TipoClientes { get; set; }
        ...
        private void CargarCombox()
        {
            try
            {
                var task = this.iTipoClientesPresentacion!.Listar();
                task.Wait();
                TipoClientes = task.Result;

                var task2 = this.iVehiculosPresentacion!.Listar();
                task2.Wait();
                Vehiculos = task2.Result;
            }
            catch (Exception ex)
            {
                LogConversor.Log(ex, ViewData!);
